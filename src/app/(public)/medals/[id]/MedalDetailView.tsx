    ...
    <div className="animate-fade-in-up">
      ...
      {!hasWikiContent && (
        <div className="mt-8 text-center py-8 text-sm text-[var(--color-text-muted)]">
          No detailed information available yet for this medal. Staff can run{" "}
          <span className="text-[var(--color-text)]">Fetch from Wikipedia</span> on the medal in admin to import summary,
          awarding criteria, and history.
        </div>
      )}
    </div>
  );
