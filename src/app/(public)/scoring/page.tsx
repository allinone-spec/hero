...
export const metadata: Metadata = {
  title: "USM-25 Scoring Matrix",
  description:
    "The Unified Scoring Matrix (USM-25) used to rank decorated military heroes. Full transparency of scoring methodology including medal values, bonuses, and combat modifiers.",
  openGraph: {
    title: "USM-25 Scoring Matrix — Medals N Bongs",
    description: "Complete scoring methodology for ranking America's most decorated military heroes.",
  },
  keywords: ["USM-25", "scoring matrix", "military scoring", "medal points", "hero ranking methodology", "valor scoring"],
};
